                ...
                <div className={styles.clientsSectionContainer}>
                    <div className={styles.clientsSectionItem}>
                        <div className={styles.clientLogoDiv}>
                            <a href="http://www.forbes.com/sites/forbestreptalks/2016/07/11/not-sure-how-to-name-a-startup-squadhelp-will-crowdsource-it-for-199" target="_blank">
                    ...
                    <div className={styles.clientsSectionItem}>
                        <div className={styles.clientLogoDiv}>
                            <a href="http://thenextweb.com/contributors/crowdsource-startup-name-with-squadhelp/" target="_blank">
                    ...
                    <div className={styles.clientsSectionItem}>
                        <div className={styles.clientLogoDiv}>
                            <a href="http://www.chicagotribune.com/bluesky/originals/ct-squadhelp-startup-names-bsi-20170331-story.html" target="_blank">
                    ...
                    <div className={styles.clientsSectionItem}>
                        <div className={styles.clientLogoDiv}>
                            <a href="http://mashable.com/2011/04/01/make-money-crowdworking/" target="_blank">
